...
async def classplus_txt(app, message):
    ...
    if "*" in user_input:
        try:
            ...
            if otp_response.status_code == 200:
                ...
                if user_otp.text.isdigit():
                    ...
                    # Step 5: Verify OTP (updated logic)
                    ...
                    if verify_response.status_code == 200:
                        ...
                        # If OTP fails or user not registered, register using same logic as standalone script
                        ...
                        if abcdefg_response.status_code == 200:
                            token = abcdefg_response.json()['data']['token']
                            s.headers['x-access-token'] = token
                    ...
                    await message.reply("Entered OTP is invalid. Please enter numbers only.")
            else:
        ...
        headers = {
            ...
            'user-agent': 'Mobile-Android',
            'app-version': '1.4.73.2',  # updated app version to match working logic
            'api-version': '35',        # updated api version
